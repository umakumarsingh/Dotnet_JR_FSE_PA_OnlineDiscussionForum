...
namespace OnlineDiscussionForum
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddPaging();
            //To Use InMemory Db
            services.AddDbContext<DiscussionForumDbContext>(options => options.UseInMemoryDatabase(databaseName: "InmemeoryAppConn"));
            //Injecting Services and Repository
            services.AddScoped<IDiscussionForumRepository, DiscussionForumRepository>();
            services.AddScoped<IDiscussionForumServices, DiscussionForumServices>();
        }
